...
<body style="margin:0;padding:0;background:#e6e1d5">
  <div style="max-width:600px;margin:0 auto;background:#faf6ee;font-family:${sans};color:${ink}">
    <div style="padding:32px 40px 20px;text-align:center">
      <div style="font-family:${serif};font-size:13px;font-weight:700;color:${accent};letter-spacing:.12em">№${issue.number}${issue.number === 0 && t.inauguralTitle ? " · " + t.inauguralTitle : issue.title ? " · " + issue.title : ""} · ${t.date(weekAgo)} — ${t.date(now)}</div>
